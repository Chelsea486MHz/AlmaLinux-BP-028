...
logvol  /var/tmp        --vgname=vg_root --size=1024 --name=lv_var_tmp
logvol  /var/log        --vgname=vg_root --size=1024 --name=lv_var_log	
logvol  /var/log/audit  --vgname=vg_root --size=1024 --name=lv_var_log_audit
logvol  /srv            --vgname=vg_root --size=1024 --name=lv_srv
logvol  /opt            --vgname=vg_root --size=1024 --name=lv_opt
